...
class AggregatorXAI(Aggregator):
    ...
    def _compute_validation_related_task_metrics(self, task_name):
        ...
        self.metric_queue.put(metric_dict) procedure (and normalizes these).
        ...
        agg_function = getattr(agg_fun_module_path,
                               self.aggregation_function_path["class_name"])() if 'rule' in tags else task_agg_function
